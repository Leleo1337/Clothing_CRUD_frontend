         ...
         <div className="absolute top-1/2 left-1/2 -translate-1/2 container max-w-[450px] p-8 bg-white shadow-xl rounded-md">
            ...
            <div className="space-y-4 pt-4">
               <div className="flex flex-col gap-1">
                  <label className="font-semibold text-gray-600 text-sm" htmlFor="email">
                     Email
                  </label>
               ...
               <div className="flex flex-col gap-1">
                  <label className="font-semibold text-gray-600 text-sm" htmlFor="password">
                     senha
                  </label>
                  <div className="relative">
                     <input
               ...
               <div>
                  <div className="flex justify-between">
                     ...
                     <div>
                        <a href="#" className="text-sm text-gray-800 font-semibold">
                           Esqueceu a senha?
                        </a>
                     </div>
                  </div>
